...
def get_sev_seg_str(number: int, min_width: int = 0) -> str:
    """Returns a seven-segment display string of number. The returned
    ...
    for i, numeral in enumerate(number):
        if numeral == ".":  # Render the decimal point.
            ...
            rows[1] += " "
            rows[2] += "."
            continue  # Skip the space in beteen digits.
        ...
        # Add a spcae (for the space in between numerals) if this
